    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          >
            <div className="mb-4.5 font-serif text-[28px] text-white">Dos niveles de análisis</div>
            <div className="mb-4 flex gap-3.5">
              ...
              <div className="text-sm leading-relaxed text-white/72">
                <strong className="text-white">Análisis por URL.</strong> Leemos el HTML de tu landing y evaluamos
                copy, CTAs, jerarquía y señales de SEO. Obligatorio.
              </div>
            </div>
            <div className="mb-6 flex gap-3.5">
              ...
              <div className="text-sm leading-relaxed text-white/72">
                <strong className="text-white">Screenshot anotado.</strong> Si subes una captura, marcamos cada
                hallazgo sobre tu imagen real con cajas y números. Opcional.
              </div>
            </div>
            <button
              onClick={onClose}
